...
class Unicorn_L(nn.Module):
    def __init__(self,out_channel=512,fp16=False):
        super(Unicorn_L,self).__init__()

        self.out_channel = out_channel
        self.fp16 = fp16

        self.conv1a = nn.Conv2d(3, 32, 3, 1, 0)
        self.relu1a = nn.ReLU(inplace=True)
        self.conv1b = nn.Conv2d(32, 64, 3, 1, 0)
        ...
        self.conv3_4 = nn.Conv2d(128, 128, 3, 1, 1)
        ...
        self.conv4_5 = nn.Conv2d(256, 256, 3, 1, 1)
        self.relu4_5 = nn.ReLU(inplace=True)
        self.conv4_6 = nn.Conv2d(256, 256, 3, 1, 1)
        self.relu4_6 = nn.ReLU(inplace=True)
        self.conv4_7 = nn.Conv2d(256, 256, 3, 1, 1)
        self.relu4_7 = nn.ReLU(inplace=True)
        self.conv4_8 = nn.Conv2d(256, 256, 3, 1, 1)
        self.relu4_8 = nn.ReLU(inplace=True)
        self.conv4_9 = nn.Conv2d(256, 256, 3, 1, 1)
        self.relu4_9 = nn.ReLU(inplace=True)
        self.conv4_10 = nn.Conv2d(256, 256, 3, 1, 1)
        ...
        self.conv5_5 = nn.Conv2d(512, 512, 3, 1, 1)
        self.relu5_5 = nn.ReLU(inplace=True)
        self.conv5_6 = nn.Conv2d(512, 512, 3, 1, 1)
        self.relu5_6 = nn.ReLU(inplace=True)

        self.conv5 = nn.Conv2d(512, 512, 3, 1, 0)
        self.relu5 = nn.ReLU(inplace=True)
        self.conv5_dw = nn.Conv2d(512,self.out_channel,4,1,0,groups=256)
...
def _unicorn_L(arch,out_channel,fp16):
    model = Unicorn_L(out_channel=out_channel,fp16=fp16)

    return model

def unicorn_L_128(out_channel=128,fp16=False) -> Unicorn_L:
    return _unicorn_L('unicorn_128',out_channel=out_channel,fp16=fp16)

def unicorn_L_256(out_channel=256,fp16=True) -> Unicorn_L:
    return _unicorn_L('unicorn_256',out_channel=out_channel,fp16=fp16)

def unicorn_L_512(out_channel=512,fp16=False) -> Unicorn_L:
    return _unicorn_L('unicorn_512',out_channel=out_channel,fp16=fp16)
